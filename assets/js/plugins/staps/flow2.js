...
function loadFlow(count){
  ...
  for(var i=1;i<=count;i++){
    ...
    if(i==1){
      ...
      flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:27%'>填写比赛项目基本信息</strong>\n";
      flowVar += "</div>\n";
    }if(i==2){
      flowVar += "<div class='flowList "+flowFor +"' style='position:relative'>\n";
      flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:30%'>关联选手/教师信息</strong>\n";
      flowVar += "</div>\n";
    }if(i==3){
      flowVar += "<div class='flowList "+flowFor +"' style='position:relative'>\n";
      flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:32%'>比赛项目申报</strong>\n";
      flowVar += "</div>\n";
    }
...
function loadFlowDiv(index){ 
 /* var strVar = "";
 if(index==1){strVar="11"}
 if(index==2){strVar="22"}
 if(index==3){strVar="33"}
 $("#iList").html(strVar);*/
