...
function loadFlow(count){
  ...
  for(var i=1;i<=count;i++){
    ...
    if(i==1){
      ...
      flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:30%'>填写赛事基本信息</strong>\n";
      flowVar += "</div>\n";
    }if(i==2){
      flowVar += "<div class='flowList "+flowFor +"' style='position:relative'>\n";
      flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:30%'>填写赛事扩展信息</strong>\n";
      flowVar += "</div>\n";
    }if(i==3){
      flowVar += "<div class='flowList "+flowFor +"' style='position:relative'>\n";
      flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:30%'>上传赛事宣传海报</strong>\n";
      flowVar += "</div>\n";
    }
  }
